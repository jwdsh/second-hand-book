...
class DangDangCrawler:
    ...
    def process_results(self):
        ...
        try:
            ...
            final_avg = statistics.mean(filtered_prices) if filtered_prices else mean_price
        ...
        return {
            ...
            'average_price': round(final_avg, 2)
        }
    ...
    def get_processed_price(self) -> float:
        """新增方法：直接返回处理后的平均价格"""
        processed_data = self.process_results()
        return processed_data['average_price'] if processed_data else 0.0
    ...
    def run(self):
        ...
        self.save_results()
        processed_data = self.process_results()
        self.save_processed_results(processed_data)
